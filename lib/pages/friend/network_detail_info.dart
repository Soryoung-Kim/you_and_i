...
class NetworkDetailInfo extends StatefulWidget {
  // NetworkDetailInfo({Key key}) : super(key: key);

  @override
  _NetworkDetailInfoState createState() => _NetworkDetailInfoState();
}

class _NetworkDetailInfoState extends State<NetworkDetailInfo> {
  Friend one = Get.arguments[0];

  Uint8List avatar = Get.arguments[1];
            ...
            children: [
              Container(
                ...
                child: Stack(
                  ...
                  _networkPictureController.getPictureInfo(avatar),)
                    // Align(
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextField(
                      enabled: false,
                      controller: TextEditingController()..text = one.homepage.toString().replaceAll('null', ' '),
                      keyboardType: TextInputType.emailAddress,
                      decoration: InputDecoration(
                        labelText: '홈페이지',
                      ),
                    ...
                    TextFormField(
                      enabled: false,
                      maxLines: null,
                      controller: TextEditingController()..text = one.address2.toString().replaceAll('null', ' '),
                      decoration: InputDecoration(
                        labelText: '상세주소',
                      ),
                      style: TextStyle(
                    ...
                    TextFormField(
                      enabled: false,
                      maxLines: null,
                      controller: TextEditingController()..text = one.memo.toString().replaceAll('null', ' '),
                      decoration: InputDecoration(
                        labelText: '메모',
                      ),
                      style: TextStyle(
